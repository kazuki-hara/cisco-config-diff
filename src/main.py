...
def convert_cisco_ios_config_to_dict(
    config_text_list: list, indent_space_num: int
) -> dict:
    config_dict = {}
    dict_key_list = []
...
if __name__ == "__main__":
    ...
    before_config_dict = convert_cisco_ios_config_to_dict(
        config_text_list=before_config_text_list, indent_space_num=1
    )
